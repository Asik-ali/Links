...
import CbseSenior from './CbseSenior';
            ...
            <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
                <div className='sm:text-center flex flex-col sm:flex-row lg:ps-24 lg:gap-20'>
                    <h3
                        ...
                        className='cursor-pointer text-white bg-[#358FFF] py-2 ps-1 text-center text-2xl w-full font-semibold sm:text-4xl mb-4 sm:mb-0'>
                        CBSE Secondary
                    </h3>
                    <h3
                        onClick={() => setShowNiosSenior(true)}
                        className='cursor-pointer w-full text-white bg-[#358FFF]  ps-1 text-center py-2 text-2xl font-semibold sm:text-4xl'>
