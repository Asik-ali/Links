                ...
                <div className="flex justify-center gap-4 items-center lg:ps-20">
                    <div className="w-10 h-10 flex-none rounded-lg bg-[#262626] flex items-center justify-center">
                        <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill='white' viewBox="0 0 24 24" strokeWidth={1.5} stroke="white">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38c-.551.318-1.26.117-1.527-.461a20.845 20.845 0 01-1.44-4.282m3.102.069a18.03 18.03 0 01-.59-4.59c0-1.586.205-3.124.59-4.59m0 9.18a23.848 23.848 0 018.835 2.535M10.34 6.66a23.847 23.847 0 008.835-2.535m0 0A23.74 23.74 0 0018.795 3m.38 1.125a23.91 23.91 0 011.014 5.395m-1.014 8.855c-.118.38-.245.754-.38 1.125m.38-1.125a23.91 23.91 0 011.014-5.395m0-3.46c.495.413.811 1.035.811 1.73 0 .695-.316 1.317-.811 1.73m0-3.46" fill='white' />
                        </svg>
                    </div>
            ...
            <div className="p-3 lg:px-4 w-full bg-white top-0 z-50 overflow-x-hidden transition-all duration-500">
                <div className="flex items-center justify-between lg:px-4">
                            ...
                            <li className="group">
                                <div className='relative'>
                                    <span className="text-[#25283A] cursor-pointer z-[99] hover:text-[#358FFF]" onClick={toggleDropdown}>
                                        Courses {isDropdownOpen ? "▲" : "▼"}
                                    </span>
                                </div>
                                <ul className={`z-10 absolute left-1/2 mt-2 space-y-2 bg-white text-[#25283A] rounded-md shadow-lg ${isDropdownOpen ? 'block' : 'hidden'}`}>
                                    <li>
                    ...
                    <div className="lg:block hidden">
                        <button className="hover:bg-[#25283A]  px-4 py-2 rounded-lg text-white  hover:scale-[0.9] bg-[#358FFF]  font-semibold  transition-all duration-500">
                            <Link to="/carrers">
                                Work With us
                            </Link>
                        </button>
                ...
                <div
                    className={
                        drop
                            ? "h-[400px] transition-all duration-600 w-[100%] lg:hidden"
                            : "h-0 overflow-hidden transition-all duration-600 w-[100%] opacity-0 lg:hidden"
                    }
                >
                    <ul className="flex flex-col mt-3 items-center bg-[#EBF3FF] py-7 justify-center font-serif gap-3 overflow-hidden ">
                        ...
                        <li
                            ...
                            className={`text-[#25283A] mt-2 ms-4 cursor-pointer hover:text-[#358FFF] ${isDropdownOpen ? 'text-[#358FFF]' : ''}`}
                        >
                            Courses {isDropdownOpen ? "▲" : "▼"}
                            {isDropdownOpen && (
                                <ul className="mt-2 space-y-2  text-[#25283A] rounded-md shadow-lg">
                                    <li>
                                        <Link to="/courses/nios" className="block z-[99] cursor-pointer px-4 py-2 hover:text-[#358FFF]">
                                            NIOS
                                        </Link>
                        ...
                        <li onClick={handleMenuToggle} className="text-white mt-2 ms-4 cursor-pointer bg-[#358FFF] py-2 px-2 hover:text-[#358FFF]">
                            <Link to="/carrers">
                                Work With us
                            </Link>
                        </li>
