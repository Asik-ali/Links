        ...
        <div className="">
            ...
            <div className="p-3 lg:px-4 w-full bg-white top-0 z-50 overflow-x-hidden transition-all duration-500">
                        ...
                        <ul className="flex gap-5 justify-center text-lg items-center ">
                            ...
                            <li className="group">
                                ...
                                <ul className={`z-10 absolute left-1/2 mt-2 space-y-2 bg-white text-[#25283A] rounded-md shadow-lg ${isDropdownOpen ? 'block' : 'hidden'}`}>
                                    ...
                                    <li>
                                        <Link to="/courses/secondary" className="block px-4 py-2 hover:text-[#358FFF]">
                                            Secondary
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/courses/higher" className="block px-4 py-2 hover:text-[#358FFF]">
                                            Higher
                                        </Link>
                                    </li>
                                </ul>
                ...
                <div
                    className={
                        drop
                            ? "h-[280px] transition-all duration-600 w-[100%] lg:hidden"
                ...
                >
                    <ul className="flex flex-col mt-3 items-center justify-center font-serif gap-3 overflow-hidden ">
                        ...
                        >
                            Courses {isDropdownOpen ? "▲" : "▼"}
                            {isDropdownOpen && (
                                <ul className="mt-2 space-y-2 bg-white text-[#25283A] rounded-md shadow-lg">
                                    <li>
                                        <Link to="/courses/nios" className="block z-[99] cursor-pointer px-4 py-2 hover:text-[#358FFF]">
                                            NIOS
                                        </Link>
